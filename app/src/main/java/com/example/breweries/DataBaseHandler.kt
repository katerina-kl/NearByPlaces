...
class BreweryDBHelper(context: Context) :
    ...
    companion object {
        ...
        private val SQL_CREATE_ENTRIES =
            "CREATE TABLE $TABLE_NAME ($COL_ID INTEGER PRIMARY KEY AUTOINCREMENT,$COL_NAME VARCHAR(256) UNIQUE,$COL_BREWERY_TYPE VARCHAR(256),$COL_STREET VARCHAR(256),$COL_ADDRESS_2 VARCHAR(256),$COL_ADDRESS_3 VARCHAR(256),$COL_CITY VARCHAR(256),$COL_STATE VARCHAR(256),$COL_COUNTY_PROVINCE VARCHAR(256),$COL_POSTAL_CODE VARCHAR(256),$COL_COUNTRY VARCHAR(256),$COL_LONGTITUDE VARCHAR(256),$COL_LATITUDE VARCHAR(256),$COL_PHONE VARCHAR(256),$COL_WEBSITE_URL VARCHAR(256),$COL_UPDATED_AT VARCHAR(256),$COL_CREATED_AT VARCHAR(256))"
